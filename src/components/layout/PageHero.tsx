...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-blue-900 pt-28 pb-16 text-white sm:pt-36 sm:pb-24">
      ...
      />
      <div
        className="bg-accent/20 pointer-events-none absolute -top-24 -right-24 h-72 w-72 rounded-full blur-3xl"
        aria-hidden="true"
      />
      <Container className="relative">
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="from-accent mt-6 h-1 w-16 rounded-full bg-linear-to-r to-white/50"
          />
          {subtitle && (
            <motion.p
              variants={fadeUp}
